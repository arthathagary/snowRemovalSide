...
const TopBanner = () => {
  return (
    <div className="px-4 py-2 rounded-lg mb-6  bg-white sm:p-8 bg-clip-padding bg-opacity-60 border border-gray-200 backdrop-blur-xl">
      <div className="text-base leading-6 font-bold sm:text-lg sm:leading-7">
        <Link href="/#rates"><p className="md:flex md:justify-center">
