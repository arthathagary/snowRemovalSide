...
Both options include FREE salt spreading (you provide the salt).</p>
    ...
    >
      ...
      <ul>
        ...
        <li className='mb-2 flex items-baseline gap-3'><span><MdStars color='black'/></span><span><span className='font-semibold text-gray-900'>Effective Snow Clearance:</span> We clear snow measuring 3 in or more using plows and high-powered snow blowers, combined with the use of plastic shovels to prevent property damage.</span></li>
