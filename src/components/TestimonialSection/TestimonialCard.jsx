...
const TestimonialCard = (props) => {
  return (
      ...
      <figure className="flex flex-col  items-center  text-center bg-gray-50 border-b border-gray-200 lg:border-r dark:bg-gray-600 dark:border-gray-700 md:p-6 rounded-xl relative p-4">
